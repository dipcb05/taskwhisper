  ...
  return (
    <Card className={className}>
      <CardHeader className="pb-3">
        ...
        {note.syncState && (
          <div className="mt-3">
            <SyncStatusBadge state={note.syncState} />
          </div>
        )}
          ...
          <TabsContent value="audio" className="mt-4">
            {note.audioUrl ? (
              <div className="rounded-lg bg-muted/50 p-4">
                <audio controls src={note.audioUrl} className="w-full rounded-lg outline-none" />
              </div>
            ) : (
              <div className="rounded-lg bg-muted/50 px-4 py-3 text-sm text-muted-foreground">
                Raw audio is not available for this recording.
              </div>
            )}
          </TabsContent>
