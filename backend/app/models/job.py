...
class Job:
    ...
    @classmethod
    async def create(cls, db: AsyncIOMotorDatabase, user_id: str, config: dict[str, Any]) -> str:
        now = datetime.utcnow()
        doc = {
            "user_id": user_id,
            "config": config,
    ...
    @classmethod
    async def update_status(cls, db: AsyncIOMotorDatabase, job_id: Any, status: str, event: dict[str, Any] | None = None) -> None:
    ...
    @classmethod
    async def save_result(cls, db: AsyncIOMotorDatabase, job_id: Any, result: dict[str, Any]) -> None:
    ...
    @classmethod
    async def get(cls, db: AsyncIOMotorDatabase, job_id: Any) -> dict[str, Any] | None:
